...
\begin{IEEEkeywords}
AI, Debate Systems, Argumentation, Conversational Agents, Argumentation Service Platform with Integrated Components (ASPIC), Data Base (DB), Retrieval-Augmented Generation (RAG).
\end{IEEEkeywords}
