...
\titleformat{\section}[block]{\normalfont\small\bfseries}{\thesection}{1em}{}[\titlerule]
...
\begin{small}
    \begin{itemize}
        \item \text{Rule-Based Agents} $\rightarrow$ Use predefined argument templates.
        \item \text{Retrieval-Based Agents} $\rightarrow$ Fetch arguments from a database.
        \item \text{Hybrid Argumentation Agents} $\rightarrow$ Combine retrieval with reasoning.
        \item \text{Hierarchical Persuasion Agents} $\rightarrow$ Adapt arguments based on user feedback.
        \item \text{Explainable Debate Agents} $\rightarrow$ Justify their reasoning using argumentation.
    \end{itemize}
\end{small}
